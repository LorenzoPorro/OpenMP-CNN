...
/*
    ...
    vector<vector<vector<vector<double>>>> kernel3(feat3, vector<vector<vector<double>>>(feat2, vector<vector<double>>(3, vector<double>(3))));
    ...
    int stride3 = round((double)(layer2[0].size() - kernel3[0][0].size())/(conv3[0].size()-1));
    ...
    // overlapped max-pooling (layer5 -> 6x6xfeat5)
    vector<vector<vector<double>>> pool6(feat5, vector<vector<double>>(6, vector<double>(6)));
    
    maxpooling(layer5,pool6);
    
    // weights matrix (2048 weights x 6x6xfeat5 input neurons)
    vector<vector<vector<vector<double>>>> weight6(2048, vector<vector<vector<double>>>(feat5, vector<vector<double>>(6, vector<double>(6))));
    ...
    // weights matrix (2048 weights x 2048 input neurons)
    vector<vector <double>> weight7(2048, vector<double>(2048));
    ...
    // layer 8 fully-connected
    vector<double> layer8(1000);

    // weights matrix (1000 weights x 2048 input neurons)
    vector<vector<double>> weight8(1000, vector<double>(2048));
